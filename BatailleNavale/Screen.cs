...
namespace BattleShip
{
    public class Screen
    {
        ...
        public int Width
        {
            get { return GameTarget.Width; }
        }

        public int Height
        {
            get { return GameTarget.Height; }
        }
        ...
        public Screen(Game game, int width, int height)
        {
            ...
            GameTarget = new RenderTarget2D(this.game.GraphicsDevice, width, height);
        ...
        public void Present(Render render, GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            render.DrawRenderTarget(GameTarget, destinationRectangle, Color.White, gameTime, spriteBatch, default);
